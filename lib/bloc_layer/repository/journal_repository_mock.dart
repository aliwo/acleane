  ...
  Future<dynamic> getAllJournalsInMonth(date) async {
    ...
    return {
      _selectedDay.subtract(Duration(days: 30)): [
        ...
        Journal(id: 1, userId: 1, routineId: 10, routineName: '비타민 D', date: _selectedDay.subtract(Duration(days: 30))),
      ...
      _selectedDay.subtract(Duration(days: 3)): [
        ...
        Journal(id: 1, userId: 1, routineId: 10, routineName: '비타민 D', date: _selectedDay.subtract(Duration(days: 20))),
        Journal(id: 1, userId: 1, routineId: 3, routineName: '미노사이클린', date: _selectedDay.subtract(Duration(days: 20))),
        Journal(id: 1, userId: 1, routineId: 8, routineName: '디페린', date: _selectedDay.subtract(Duration(days: 20))),
      ],
      _selectedDay.subtract(Duration(days: 2)): [
        ...
        Journal(id: 1, userId: 1, routineId: 10, routineName: '비타민 D', date: _selectedDay.subtract(Duration(days: 16))),
      ],
      _selectedDay.add(Duration(days: 10)): [
        ...
        Journal(id: 1, userId: 1, routineId: 8, routineName: '디페린', date: _selectedDay.subtract(Duration(days: 10))),
        Journal(id: 1, userId: 1, routineId: 10, routineName: '비타민 D', date: _selectedDay.subtract(Duration(days: 10))),
      ],
      _selectedDay.add(Duration(days: 4)): [
        ...
        Journal(id: 1, userId: 1, routineId: 8, routineName: '디페린', date: _selectedDay.subtract(Duration(days: 4))),
        Journal(id: 1, userId: 1, routineId: 10, routineName: '비타민 D', date: _selectedDay.subtract(Duration(days: 4))),
      ],
      _selectedDay.add(Duration(days: 2)): [
        ...
        Journal(id: 1, userId: 1, routineId: 8, routineName: '디페린', date: _selectedDay.subtract(Duration(days: 2))),
      ]
    };
  }
}
